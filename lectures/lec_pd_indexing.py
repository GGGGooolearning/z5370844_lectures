...
# x = ser.loc['2020-01-10'] # use index find data 7.0
# print(x)
# The following will raise a KeyError
#y = ser.loc['3000-01-10'] # key not exist
# print(y)
...
# z = df.loc['b':'e', :] # dataframe
# z = df.loc['b':'e', 'col1'] # series
# print(df)
# z = df.loc[['b', 'd', 'f', 'j'], ['col1']] # dataframe
# print(z)
# print(type(z))
# ----------------------------------------------------------------------------
...
# print(x) #single positional indexer is out-of-bounds
